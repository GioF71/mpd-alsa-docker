...
---|---|---
MPD_AUDIO_DEVICE|default|The audio device. Common examples: `hw:DAC,0` or `hw:x20,0` or `hw:X20,0` for usb dac based on XMOS                                                      ALSA_DEVICE_NAME|Alsa Device|Name of the Alsa Device
